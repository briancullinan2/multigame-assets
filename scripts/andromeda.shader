...
textures/andromeda_lights/u_lamp1r
{
	qer_editorimage textures/andromeda_lights/u_lamp1r.tga
	q3map_lightimage textures/andromeda_lights/u_lamp_blendr.tga
	surfaceparm nodlight
	surfaceparm nomarks
	q3map_surfacelight 2200
	{
		map textures/andromeda_lights/u_lamp1r.tga
		rgbGen identity
	}
	{
		map $lightmap 
	...
	{
		map textures/andromeda_lights/u_lamp_blendr.tga
		blendfunc gl_one_minus_dst_color gl_one
	}
}
